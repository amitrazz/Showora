              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  {invoice.outstandingAmount > 0 && (
                    <Button className="shadow-sm bg-primary text-primary-foreground">
          ...
          <Card className="shadow-soft border-border/50 animate-in fade-in duration-500">
            <CardContent className="p-6 sm:p-10">
              <div className="flex justify-between items-center mb-8">
                ...
                {invoice.outstandingAmount > 0 && <Button variant="outline" size="sm"><CreditCard className="h-4 w-4 mr-2" /> Record Collection</Button>}
              </div>
