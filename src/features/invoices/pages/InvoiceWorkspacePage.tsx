...
import { usePrintDocument, usePdfExport } from "@/shared/print";
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="right">
                      <DropdownMenuItem onClick={() => printDocument("invoice", invoice)}>
        ...
        {activeTab === "pdf" && (
          <div className="space-y-4 animate-in fade-in duration-500">
            <div className="flex justify-end gap-3">
              <Button variant="outline" size="sm" onClick={() => printDocument("invoice", invoice)}>
                <Printer className="mr-2 h-4 w-4" /> Print
              </Button>
              <Button 
                variant="outline" 
                size="sm" 
                onClick={() => exportPdf("invoice", invoice, `Invoice_${invoice.invoiceNumber}.pdf`)}
              >
